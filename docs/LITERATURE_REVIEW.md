...
The detailed history of the original marked-row case is:
...
The eight source intervals and present publication status are:

| Cell | Bhan--Nobili--Langer v2 interval | Evidence supplied here | Current status |
|---|---:|---|---:|
