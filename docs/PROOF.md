...
The upper-bound proof above was generated by **GPT 5.6-Sol**, which also produced the formal arithmetic, verification code, and repository. This is a research artifact awaiting independent expert review, not a peer-reviewed publication.

The proof is entirely human-readable: no solver output is needed for the upper bound. The repository's programs serve three narrower purposes:
